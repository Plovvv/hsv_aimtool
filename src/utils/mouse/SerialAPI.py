"""Модуль низкоуровневой работы с аппаратными контроллерами по Serial (CVM API).

Обеспечивает автоматический поиск, открытие, закрытие и управление
микроконтроллерами типа MAKCU или CH34x/CP2102 на скоростях до 4 000 000 бод.
Поддерживает аппаратное переключение каналов и блокировки осей ввода.
"""
